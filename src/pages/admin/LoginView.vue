  ...
  <div class="min-h-screen bg-[#fff8f9] flex items-center justify-center px-4">
    <div class="w-full max-w-sm">
      <div class="text-center mb-8">
        <h1 class="text-2xl font-bold text-[#3B2A35]">Admin Saphirus</h1>
        <p class="text-sm text-gray-400 mt-1">Ingresá para administrar la tienda</p>
      </div>
      <form @submit.prevent="handleLogin" class="bg-white/80 backdrop-blur-sm border border-rose-200/40 rounded-2xl p-6 shadow-sm space-y-4">
        <div>
